  ...
  <div className="flex gap-6 sm:gap-10 items-center justify-center">
    ...
    <div className="tool-icon">
      <svg viewBox="0 0 256 256" width="40" height="40" xmlns="http://www.w3.org/2000/svg">
        <path d="M181.534 254.252a15.934 15.934 0 0 0 12.7-.488l52.706-25.361a16.002 16.002 0 0 0 9.06-14.42V42.018c0-6.15-3.522-11.754-9.06-14.42L194.234 2.238a15.939 15.939 0 0 0-18.185 3.097c-100.659 92.746-100.569 92.746-101.303 93.264-2.077 1.467-82.166-68.571-82.166-68.571a10.657 10.657 0 0 0-13.599-.528L4.545 50.851a10.666 10.666 0 0 0-.009 16.428l62.156 57.17L4.537 181.679a10.666 10.666 0 0 0 .009 16.428l24.436 21.351a10.656 10.656 0 0 0 13.599-.528c0 0 80.083-70.038 82.16-68.571.734.518.764.489 101.309 93.264a15.914 15.914 0 0 0 5.484 10.629zm10.705-184.367L115.479 128l76.76 58.115V69.885z" fill="#007ACC"/>
      </svg>
    </div>
    {/* Linear */}
    <div className="tool-icon">
      <svg viewBox="0 0 256 256" width="40" height="40" xmlns="http://www.w3.org/2000/svg">
        <g>
          <path d="M128 234.667L234.667 128L256 149.333L128 277.333L0 149.333L21.333 128L128 234.667Z" fill="#5E6AD2"/>
          <path d="M128 21.333L21.333 128L0 106.667L128 -21.333L256 106.667L234.667 128L128 21.333Z" fill="#5E6AD2"/>
        </g>
      </svg>
    </div>
    {/* Slack */}
