...
// 4. Tool Logos
const ToolLogos = () => (
  <div className="flex gap-6 sm:gap-10 items-center justify-center text-gray-400">
    {/* VS Code */}
    ...
    {/* Linear */}
    <svg className="h-8 w-8" viewBox="0 0 24 24" fill="currentColor">
      <path d="M2.846 5.887a.93.93 0 0 1 1.36-.63l14.23 8.23a.93.93 0 0 1 0 1.6l-4.57 2.64a.93.93 0 0 1-1.36-.63L2.846 5.887zm-.846-.846a.93.93 0 0 0-.93.93v9.058a.93.93 0 0 0 1.36.78l4.57-2.64a.93.93 0 0 0 .5-.78V5.97a.93.93 0 0 0-1.5-.93zm18.5 0a.93.93 0 0 1 1.5.93v9.058a.93.93 0 0 1-.5.78l-4.57 2.64a.93.93 0 0 1-1.36-.78V5.97a.93.93 0 0 1 .93-.93z" fillRule="evenodd"/>
    </svg>
    {/* Slack */}
    <svg className="h-8 w-8" viewBox="0 0 24 24" fill="currentColor">
      <path d="M5.042 15.165a2.528 2.528 0 0 1-2.52 2.523A2.528 2.528 0 0 1 0 15.165a2.527 2.527 0 0 1 2.522-2.52h2.52v2.52zM6.313 15.165a2.527 2.527 0 0 1 2.521-2.52 2.527 2.527 0 0 1 2.521 2.52v6.313A2.528 2.528 0 0 1 8.834 24a2.528 2.528 0 0 1-2.521-2.52v-6.315zm8.834-5.042a2.528 2.528 0 0 1 2.521-2.52A2.528 2.528 0 0 1 20.19 5.08a2.528 2.528 0 0 1-2.521 2.52h-2.52v-2.52zM8.834 6.313a2.528 2.528 0 0 1 2.521 2.521 2.528 2.528 0 0 1-2.521 2.521H2.522A2.528 2.528 0 0 1 0 8.834a2.528 2.528 0 0 1 2.522-2.521h6.312zm6.313 2.521a2.527 2.527 0 0 1 2.52-2.52 2.527 2.527 0 0 1 2.522 2.52v6.313A2.527 2.527 0 0 1 17.669 17.669a2.528 2.528 0 0 1-2.522-2.52V8.834zM17.669 6.313a2.528 2.528 0 0 1-2.522 2.521 2.527 2.527 0 0 1-2.522-2.521V0a2.528 2.528 0 0 1 2.522 2.521 2.527 2.527 0 0 1 2.522 2.521v1.271z"/>
    </svg>
    {/* Discord */}
    <svg className="h-8 w-8" viewBox="0 0 24 24" fill="currentColor">
    ...
    {/* Notion */}
    <svg className="h-8 w-8" viewBox="0 0 24 24" fill="currentColor">
      <path d="M4.459 4.208c.746.606 1.026.56 2.547.33l13.588-.254c.28 0 .047-.28-.094-.466L17.64 1.968c-.42-.326-.981-.7-2.25-.7L3.577 2.38c-.747.046-.887.327-.888.933l.008 14.7c.014.752.327.933 1.05.606l3.28-1.02 13.537-.327c.327-.014.61-.28.61-.653V5.653c-.047-.28-.28-.466-.56-.42l-15.073.933c-.327.047-.56.233-.466.606z"/>
    </svg>
    {/* GitHub */}
    <svg className="h-8 w-8" viewBox="0 0 24 24" fill="currentColor">
