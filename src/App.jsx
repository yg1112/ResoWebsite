  ...
  <div className="flex gap-6 sm:gap-10 items-center justify-center">
    ...
    <div className="tool-icon">
      <svg viewBox="0 0 24 24" width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M23.5 18.2L16.2 23.3C15.9 23.5 15.5 23.5 15.2 23.3L1.5 13.9C0.9 13.5 0.9 12.6 1.4 12.1L5.8 7.7L16.2 0.7C16.5 0.5 16.9 0.5 17.2 0.7L23.5 5.8C24.2 6.3 24.2 7.3 23.5 7.8L18.7 12L23.5 16.2C24.1 16.7 24.1 17.7 23.5 18.2ZM15.4 19.8L21 15.9L15.4 12L15.4 19.8ZM15.4 4.2L21 8.1L15.4 12V4.2ZM3.7 12L6.8 15.1L13.4 19.6L13.4 4.4L6.8 8.9L3.7 12Z" fill="#007ACC"/>
      </svg>
    </div>
    {/* Linear */}
    <div className="tool-icon">
      <svg viewBox="0 0 24 24" width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M12.0002 22.4141L21.4142 12.9999L22.8284 14.4141L12.0002 25.2425L1.17173 14.4141L2.58594 12.9999L12.0002 22.4141Z" fill="#5E6AD2"/>
        <path d="M12.0002 11.5857L2.58594 2.17148L1.17173 0.757263L12.0002 -10.0712L22.8284 0.757263L21.4142 2.17148L12.0002 11.5857Z" fill="#5E6AD2"/>
      </svg>
    </div>
    {/* Slack */}
    <div className="tool-icon">
      <svg viewBox="0 0 24 24" width="32" height="32" xmlns="http://www.w3.org/2000/svg">
        <path d="M5.042 15.123a2.52 2.52 0 0 1 2.52-2.52h2.52v2.52a2.52 2.52 0 0 1-5.04 0zm7.56-2.52a2.52 2.52 0 0 1 2.52-2.52 2.52 2.52 0 0 1 2.52 2.52v2.52h-2.52a2.52 2.52 0 0 1-2.52-2.52zm0-7.56a2.52 2.52 0 0 1 0 5.04h-2.52v-2.52a2.52 2.52 0 0 1 2.52-2.52zm-2.52 7.56a2.52 2.52 0 0 1-2.52 2.52 2.52 2.52 0 0 1-2.52-2.52v-2.52h2.52zm-2.52-7.56a2.52 2.52 0 0 1 2.52-2.52 2.52 2.52 0 0 1 2.52 2.52v2.52h-2.52a2.52 2.52 0 0 1-2.52-2.52zm7.56 2.52a2.52 2.52 0 0 1 0-5.04h2.52v2.52a2.52 2.52 0 0 1-2.52 2.52zm2.52 5.04a2.52 2.52 0 0 1 2.52-2.52 2.52 2.52 0 0 1 2.52 2.52v2.52h-2.52a2.52 2.52 0 0 1-2.52-2.52z" fill="#E01E5A"/>
      </svg>
    </div>
    {/* Discord */}
    <div className="tool-icon">
    ...
    <div className="tool-icon">
      <svg viewBox="0 0 24 24" width="32" height="32" xmlns="http://www.w3.org/2000/svg">
        <path d="M4.192 3.146a.434.434 0 0 0-.02-.022L2.556 1.169a.46.46 0 0 0-.74.453l.487 3.328a.333.333 0 0 0 .329.284h.478v13.682H2.333a.333.333 0 0 0-.333.333v2.094c0 .184.149.333.333.333h5.977a.333.333 0 0 0 .333-.333v-2.094a.333.333 0 0 0-.333-.333h-.675V6.26l8.89 11.233c.045.056.098.106.158.147.164.113.37.126.549.034l5.37-2.685a.46.46 0 0 0 .257-.492l-1.127-6.263a.333.333 0 0 0-.328-.274h-.492V4.91h1.16a.333.333 0 0 0 .333-.333V2.483a.333.333 0 0 0-.333-.333h-6.19a.333.333 0 0 0-.256.12L8.293 14.156V4.91h1.41a.333.333 0 0 0 .333-.333V2.483a.333.333 0 0 0-.333-.333H4.192z" fill="#000000"/>
      </svg>
    </div>
    {/* GitHub */}
    <div className="tool-icon">
