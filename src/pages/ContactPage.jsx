...
const contactCopy = {
  en: {
    ...
    title: 'Build with Us',
    intro:
      "We're excited to shape Reso together with you. Your feedback drives our evolution. Whether it's a feature idea, frustration, or bug report — we'd love to hear from you.",
    ...
    messagePlaceholder: "Tell us what features you'd like to see in Reso, or what doesn't feel right. If you'd like, share your use case too...",
  ...
  zh: {
    ...
    sectionTag: '联系我们',
    title: '共建 Reso',
    intro: '很高兴能和你一起打磨 Reso。你的反馈是我们进化的动力。无论是新功能灵感、使用上的吐槽，还是 Bug 报告，都欢迎直接告诉我们。',
    nameLabel: '怎么称呼你？',
    ...
    messagePlaceholder: '告诉我们你希望 Reso 增加什么功能，或者哪里让你觉得不好用。如果不介意，也可以聊聊你的使用场景...',
    uploadLabel: '上传文件',
  ...
  ja: {
    ...
    sectionTag: 'Contact',
    title: '一緒に作る Reso',
    intro: 'あなたと一緒に Reso を磨き上げることを楽しみにしています。あなたのフィードバックが私たちの進化の原動力です。新機能のアイデア、使いにくい点、バグ報告など、何でもお聞かせください。',
    nameLabel: '何とお呼びすればよろしいですか？',
    namePlaceholder: 'お名前 / ニックネーム',
    emailLabel: 'メールアドレス',
    emailPlaceholder: '返信用',
    messageLabel: 'どのようなご意見がありますか？',
    messageHint: 'ご意見、アイデア、または遭遇した問題を共有してください。',
    messagePlaceholder: 'Reso に追加してほしい機能や、使いにくいと感じた点を教えてください。よろしければ、使用ケースも共有していただけると幸いです...',
    uploadLabel: 'ファイル添付',
    uploadHint: 'スクリーンショットまたは画面収録（任意）— 百聞は一見に如かず。問題の特定に役立ちます。',
