      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl font-medium text-gray-900 dark:text-gray-100 mb-4">Your local intelligence, working for your thoughts.</h1>
            <p className="text-base text-gray-500 dark:text-gray-400">Pay once. Own forever.</p>
          </div>

          {/* Pricing Card */}
          <div className="flex justify-center mb-24">
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 dark:border-gray-800 rounded-2xl p-8 md:p-10 max-w-sm w-full">
              {/* Card Header */}
              <div className="mb-6">
                ...
                <div className="flex items-baseline mb-3">
                  <span className="text-4xl font-medium text-gray-900 dark:text-gray-100">$29</span>
                  <span className="text-2xl text-gray-900 dark:text-gray-100">.99</span>
                </div>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex gap-3 items-start">
                  <div className="p-1.5 bg-gray-100 dark:bg-gray-800 rounded-lg shrink-0 mt-0.5">
                    <Cpu size={14} className="text-gray-600 dark:text-gray-400" />
                  </div>
                  <span className="text-sm text-gray-600 dark:text-gray-400">Engineered for Neural Engine</span>
                </li>
                <li className="flex gap-3 items-start">
                  <div className="p-1.5 bg-gray-100 dark:bg-gray-800 rounded-lg shrink-0 mt-0.5">
                    <Zap size={14} className="text-gray-600 dark:text-gray-400" />
                  </div>
                  <span className="text-sm text-gray-600 dark:text-gray-400">Optimized for local workflows</span>
                </li>
                <li className="flex gap-3 items-start">
                  <div className="p-1.5 bg-gray-100 dark:bg-gray-800 rounded-lg shrink-0 mt-0.5">
                    <Lock size={14} className="text-gray-600 dark:text-gray-400" />
                  </div>
                  <span className="text-sm text-gray-600 dark:text-gray-400">100% local processing</span>
                </li>
              </ul>
              ...
              <div className="flex flex-col gap-2">
                <button
                  onClick={handleBuy}
                  className="w-full group flex items-center justify-center gap-2 text-sm py-3 px-6 bg-black dark:bg-white text-white dark:text-black rounded-lg font-medium hover:bg-gray-800 dark:hover:bg-gray-100 dark:bg-gray-800 transition-all"
                >
              ...
              <div className="space-y-0">
                {faqs.map((faq, index) => (
                  <div key={index} className="border-t border-gray-200 dark:border-gray-800">
                    ...
                    >
                      <span className="text-sm text-gray-900 dark:text-gray-100 group-hover:text-gray-600 dark:text-gray-400 transition-colors pr-4">
                        {faq.q}
                      </span>
                      <ChevronDown
                        size={18}
      ...
      <section className="py-24 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <a
            ...
            download
            className="inline-flex items-center gap-2 bg-black dark:bg-white text-white dark:text-black rounded-lg font-medium text-sm hover:bg-gray-800 dark:hover:bg-gray-100 dark:bg-gray-800 transition-all px-6 py-3"
          >
            <Download size={16} />
