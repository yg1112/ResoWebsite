...
const pricingCopy = {
  en: {
    titleLine1: 'Think out loud.',
    titleLine2: 'Let Reso handle the rest.',
    subtitle:
      'Start free with your own API keys, or upgrade to Pro for unlimited AI-powered dictation and insights.',
    tiers: [
      {
        id: 'free',
        name: 'Reso',
        ...
        features: [
          ...
          'Zero cost: bring your own API keys forever.',
        ],
        cta: 'Start 14-Day Pro Trial',
        checkoutUrl: CHECKOUT_LINKS.free,
        footnote: '14-day Pro trial · No credit card needed',
      },
      {
        id: 'plus',
        name: 'Reso Pro',
        ...
        features: [
          'Full control: switch freely between verbatim transcript and polished output.',
          'Automate tasks: build visual skill chains for dictations.',
          'Discover insights: reveal thinking habits via Nebula.',
          'Thought nebula: gather your notes, traverse your thinking, discover hidden connections.',
          'Improve accuracy: AI learns your vocabulary over time.',
        ],
        cta: 'Upgrade to Pro',
        checkoutUrl: CHECKOUT_LINKS.plus,
        footnote: '$100/year (save 2 months) · Cancel anytime · 30-day refund',
        featured: true,
      },
    ],
  ...
  zh: {
    titleLine1: '想到就说。',
    titleLine2: '剩下的交给 Reso。',
    subtitle: '免费使用自带 API Key 听写，或升级专业版享受无限 AI 听写与深度洞察。',
    tiers: [
      {
        id: 'free',
        name: 'Reso',
      ...
      },
      {
        ...
        features: [
          '随心掌控：自由切换逐字原稿与精炼排版。',
          '自动处理：可视化构建专属听写工作流。',
          '洞察思维：通过星云发现你的思考习惯与节律。',
          '思维星云：汇聚本地笔记，穿梭你的思维轨迹，发现灵感连接。',
          '越用越准：AI 自动学习你的专属词汇。',
        ],
        cta: '升级到专业版',
        checkoutUrl: CHECKOUT_LINKS.plus,
        footnote: '年付 $100（省两个月）· 随时取消 · 30 天退款',
        featured: true,
      },
    ],
    mostPopular: '最受欢迎',
  ...
  ja: {
    titleLine1: '思ったまま話す。',
    titleLine2: 'あとは Reso に任せて。',
    subtitle: '自分の API キーで無料から始めるか、Pro にアップグレードして無制限の AI ディクテーションとインサイトを。',
    tiers: [
      {
        id: 'free',
        name: 'Reso',
        ...
        cta: '14日間の Pro 体験を開始',
        checkoutUrl: CHECKOUT_LINKS.free,
        footnote: '14日間 Pro 体験 · クレジットカード不要',
      },
      {
        id: 'plus',
        name: 'Reso Pro',
        ...
        features: [
          '自在な出力：逐語記録と洗練された文章を自由に切り替え。',
          'タスク自動化：ビジュアルなスキルチェーンを構築。',
          '思考を発見：Nebula で習慣とリズムを可視化。',
          '思考ネビュラ：ノートを集めて思考の軌跡を旅し、インスピレーションの繋がりを発見。',
          '使うほど精確：AI があなたの語彙を自動学習。',
        ],
        cta: 'Pro にアップグレード',
        checkoutUrl: CHECKOUT_LINKS.plus,
        footnote: '年額 $100（2ヶ月分お得）· いつでも解約可 · 30日返金',
        featured: true,
      },
    ],
    mostPopular: '人気プラン',
