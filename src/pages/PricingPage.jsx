    ...
    tiers: [
      {
        ...
        features: [
          'Output mode: raw transcript only.',
          'Workflow: manual dictation only.',
          'Nebula insights: not included.',
          'Adaptive vocabulary: not included.',
          'Billing: bring your own API keys.',
        ],
      ...
      },
      {
        ...
        features: [
          'Output mode: raw transcript + polished rewrite.',
          'Workflow: visual skill chains included.',
          'Nebula insights: clustered notes and thought patterns.',
          'Adaptive vocabulary: learns your terms over time.',
          'Billing: API usage included (fair use).',
        ],
        cta: 'Upgrade to Pro',
  ...
  ja: {
    ...
    tiers: [
      ...
      },
      {
        ...
        features: [
          '出力モード：逐語転写 + 自動整文。',
          'ワークフロー：ビジュアルなスキルチェーン。',
          'Nebula インサイト：ノートを意味でクラスタ化。',
          '語彙の学習：使うほどあなたに最適化。',
          '料金：API 利用込み（公正利用内）。',
        ],
        cta: 'Pro にアップグレード',
