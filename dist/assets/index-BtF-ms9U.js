...
`).filter(r=>r.startsWith("### ")).map((r,o)=>{const i=r.replace("### ","").trim(),l=Cg(i)||`section-${o+1}`,s=n.get(l)||0;return n.set(l,s+1),{id:s===0?`${t}-${l}`:`${t}-${l}-${s+1}`,label:i}})},Rg=({post:e,headingPrefix:t="journey"})=>{if(!e)return null;const n=Td(e.content,t);let r=0;return a.jsxs("div",{className:"space-y-6",children:[a.jsxs("div",{className:"mb-8",children:[a.jsxs("div",{className:"flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400 mb-3",children:[a.jsx("span",{children:e.date}),a.jsx("span",{className:"w-1 h-1 rounded-full bg-gray-300 dark:bg-gray-600"}),a.jsx("span",{children:e.category})]}),a.jsx("h2",{className:"text-2xl md:text-3xl font-medium text-gray-900 dark:text-gray-100",children:e.title})]}),a.jsx("div",{className:"prose-content",children:e.content.split(`
